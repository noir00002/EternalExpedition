...
import eternalexpedition.util.TriFunction;
...
import static eternalexpedition.util.GeneralUtils.removePrefix;
import static eternalexpedition.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return EEMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    EEMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
    ...
    public void applyPowers() {
        if (!inCalc) {
            ...
            if (isMultiDamage && AbstractDungeon.getCurrRoom() != null
